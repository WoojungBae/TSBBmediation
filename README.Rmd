---
title: rBARTmediation: Mediation analysis using Bayesian Additive Regression Trees (BART) with random effects and two-stage Bayesian bootstrap (TSBB).
...
The R package **rBARTmediation** is intended to be a user-friendly mediation analysis using Bayesian 
Additive Regression Trees (BART) with random effects and two-stage Bayesian bootstrap (TSBB).
